...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2025 at 11:32 AM
...
INSERT INTO `customers` (`id`, `user_id`, `name`, `email`, `phone`, `address`, `photo`, `created_at`) VALUES
(1, 7, 'Ministeriu Agrikultura no Peskas (MAP)', 'info.mapagri@maf.gov.tl', '+670 77301788', 'Nicolau Lobato, Díli, Timor-Leste', 'uploads/1744016860_MAP.jpg', '2025-04-07 04:25:22'),
(4, 7, 'FAO Representation in Timor-Leste', 'FAO-TP@fao.org', '+6703312961', 'Ministry of Agriculture\r\nRua Avenida Presidente Nicolau Lobato, No. 5 Dili, Timor-Leste', 'uploads/1744016606_FAO.jpg', '2025-04-07 09:02:03');
...
INSERT INTO `employees` (`id`, `name`, `role`, `schedule`, `payroll`, `performance`, `created_at`) VALUES
(1, 'Eligio de Oliveira', 'Staff', 'Monday- Saturday 8:00am-8:30 pm', '100.00', 'Average', '2025-04-05 07:56:46');
...
INSERT INTO `orders` (`id`, `customer_id`, `customer_name`, `total_price`, `created_at`) VALUES
(1, 0, '', '4.00', '2025-04-03 09:56:42'),
(2, 0, '', '6.00', '2025-04-03 10:13:49'),
(3, 0, '', '4.00', '2025-04-03 11:58:23'),
(4, 0, '', '25.00', '2025-04-05 06:32:33'),
(5, 0, '', '99999999.99', '2025-04-05 07:09:21'),
(6, 0, '', '71.75', '2025-04-07 04:41:26');
...
(4, 'Binding (Jilit lakban) A4', 'Binding (Jilit lakban)', 'Unit', 'Binding (Jilit lakban) A4', '0', '0.75', 1995, '2025-04-03 08:28:02', '0.00', 'uploads/prod_67ee75c79f9744.11951880_Binding (Jilit lakban) A3.jpeg'),
(5, 'Binding (Jilit lakban) A3', 'Binding (Jilit lakban)', 'Unit', 'Binding (Jilit lakban) A3', '0', '2.00', 1995, '2025-04-03 08:30:01', '0.00', 'uploads/prod_67ee71c98f09e1.55666881_Binding (Jilit lakban) A3.jpeg'),
(6, 'Binding Spiral (Jilit Spiral) A4', 'Binding Spiral (Jilit Spiral)', 'Unit', 'Binding Spiral (Jilit Spiral) A4', '0', '3.50', 1995, '2025-04-03 09:01:58', '0.00', 'uploads/prod_67ee75b012ad41.78260259_Binding Spiral (Jilit Spiral) A3.jpeg'),
(8, 'Binding Spiral (Jilit Spiral) A3', 'Binding Spiral (Jilit Spiral)', 'Unit', 'Binding Spiral', '0', '4.00', 1994, '2025-04-03 09:31:24', '0.00', 'uploads/prod_67ee758c7d5f97.65362575_Binding Spiral (Jilit Spiral) A3.jpeg'),
...
(12, 'Book Separator  A4', 'Book Separator', 'Paper', 'Book Separator  A4', '0', '0.50', 1995, '2025-04-03 09:36:17', '0.00', 'uploads/prod_67ee74e43ab2e6.78290726_Book Separator A4.jpeg'),
...
(17, 'Binder Clips No.155', 'Clips', 'Box', 'Binder Clips', '0', '4.00', 1995, '2025-04-03 09:39:54', '0.00', 'uploads/prod_67ee715f06afa0.41806044_Binder Clips No.155.jpeg'),
...
(26, 'Copia Metan, Mutin (Copy black and white) A4', 'Copy black and white A4', 'Paper', 'Copy black and white', '', '0.10', 2147483637, '2025-04-05 06:49:36', '0.00', 'uploads/prod_67f0d28099c165.83978295_Copy black and white A4.jpeg'),
(27, 'Copia Metan, Mutin (Copy black and white)  A3', 'Copy black and white A3', 'Paper', 'Copy black and white', '', '0.25', 2147483641, '2025-04-05 06:50:33', '0.00', 'uploads/prod_67f0d2b9abc064.68693646_Copy black and white A4.jpeg'),
(28, 'Copia Koloridu (Copy color) A4', 'Copia Koloridu (Copy color) A4', 'Paper', 'Copy color', '', '0.50', 2147483645, '2025-04-05 06:54:11', '0.00', 'uploads/prod_67f0d393ec96b6.51334141_Copia Koloridu Copy color  A4.jpeg'),
...
(30, 'Laptop HP Intel Core 5', 'HP', 'Unit', 'Laptop', '(Intel Core 5 Ram 8GB) Hard Disk (Room 250GB), no bag and mouse', '700.00', 10, '2025-04-07 03:07:18', '0.00', 'uploads/prod_67f34166575804.56015192_WhatsApp Image 2024-02-05 at 11.24.41_1fc3e313.jpg'),
(31, 'Laptop Lenovo Intel Core 5', 'Lenovo', 'Unit', 'Laptop', 'Intel Core 5, Ram 8GB, ) Hard Disk (Room 250GB) ), no bag \r\nand mouse', '700.00', 10, '2025-04-07 03:08:21', '0.00', 'uploads/prod_67f341a56e8f86.99576872_WhatsApp Image 2024-02-05 at 11.24.41_93540b23.jpg');
...
CREATE TABLE `settings` (
  ...
  `user_background_color` varchar(7) NOT NULL DEFAULT '#ffffff',
  `staff_background_color` varchar(7) NOT NULL DEFAULT '#ffffff'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `settings` (`id`, `background_color`, `text_color`, `button_color`, `user_background_color`, `staff_background_color`) VALUES
(1, '#26df32', '#000000', '#007bff', '#090606', '#dd0e0e');
...
(7, 'Jtnewtrong', '$2y$10$AOU9eWa8EIGX0Cx50VC3fefhbwIFJ0Szq4Y7miwHJnqhzI1zOHXtW', 'admin', '2025-04-07 02:35:25'),
(8, 'Mariano x', '$2y$10$ioWS/XfRR7wbtCYeGDNXYOj3K.y9igWjSp6UwC12rxBdxQEx3aqGG', 'other', '2025-04-07 02:57:13');
